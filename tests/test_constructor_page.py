...
class TestConstructorPage:
    def test_bun_section_opening(self,authorization):
        ...
        assert SELECTED_SECTION_OF_CONSTRUCTOR in driver.find_element(*BUN_SECTION).get_dom_attribute('class')
    ...
    def test_sauce_section_opening(self,authorization):
        ...
        assert SELECTED_SECTION_OF_CONSTRUCTOR in driver.find_element(*SAUCE_SECTION).get_dom_attribute('class')
    ...
    def test_fillings_section_opening(self,authorization):
        ...
        assert SELECTED_SECTION_OF_CONSTRUCTOR in driver.find_element(*FILLINGS_SECTION).get_dom_attribute('class')
